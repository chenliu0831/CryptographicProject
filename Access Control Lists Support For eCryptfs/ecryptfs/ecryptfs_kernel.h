...
#define ECRYPTFS_SETACL _IOW('g', 1, struct user_posix_acl *)
#define ECRYPTFS_GETACL _IOR('g', 2, struct user_acl_list *)
...
#define ECRYPTFS_ACL_NAME_LEN 21

//#define ACL_PROCESS             (0x40)
//#define ACL_SESSION             (0x80)
//#define ACL_TIME                (0x90)
...
int ecryptfs_set_acl(struct dentry *dentry, int type, 
		     struct posix_acl *acl);
int ecryptfs_get_acl(struct dentry *dentry, int type, struct posix_acl **acl, char *name);
